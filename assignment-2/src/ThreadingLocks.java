...
public class ThreadingLocks extends Thread {
    boolean mutex = false;
    String city_name;
    String zip_code;
    String query;
    ...
    ThreadingLocks(String cityName,String code, String prio,FileWriter fw){
        city_name = cityName;
        zip_code = code;
        priority = prio;
    ...
    public void run(){
        try {
            ...
            fileWriter.write("Line 25: Connection establisheed \n");
            fileWriter.flush();
            ...
            if(!mutex){ 
                ...
                fileWriter.write("Line 32: Select statement executed \n");
                fileWriter.flush();
                ...
                if(priority == "high"){
                    sleep(4000);
                    mutex = false;
                    fileWriter.write("LOCK RELEASED \n");
                    con1.commit();
                ...
                fileWriter.write("Lock in place");
            }
